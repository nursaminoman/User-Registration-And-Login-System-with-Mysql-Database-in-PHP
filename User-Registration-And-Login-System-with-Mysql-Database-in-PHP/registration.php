...
<html lang="en">
  <head>
    ...
    <title>Registration | User Registration And Login System with Mysql Database in PHP</title>
...
<main class="form-signin w-100 m-auto">
  <form method="POST" action="backend/RegistrationPost.php">
    ...
    <div class="form-floating">
      <input type="name" name="name" class="form-control" id="floatingInput" placeholder="Enter Full Name">
      <?php
